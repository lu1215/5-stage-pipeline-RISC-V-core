...
class chisel_CPU(pluginTemplate):
    __model__ = "chisel_CPU"
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","chisel_CPU")
        self.dut_exe = f'sbt "testOnly riscv.riscv_arch_test.RiscvArchTest -- -DelfFile={{elfFile}}"'
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for chisel_CPU start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
